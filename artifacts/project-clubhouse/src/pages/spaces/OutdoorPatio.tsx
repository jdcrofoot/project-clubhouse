...
import imgOutdoorPatio from "@assets/generated_images/vision_board_outdoor_patio_v2.png";
      ...
      <section className="relative z-10 bg-black">
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 flex items-end justify-between p-8 bg-gradient-to-t from-black/80 to-transparent">
            <span className="font-display text-xs uppercase tracking-[0.3em] text-primary font-bold">Vision Board · Zone 04</span>
            <span className="font-display text-xs uppercase tracking-widest text-white/50">The Outdoor Patio</span>
          </div>
        </div>
      </section>
